...
import BlenderbotTokenizer
import BlenderbotForConditionalGeneration
...
diabetic_model = pk.load(open('C:/Users/J RISHI KRISHNA/study/vs/WS/streamlit/Diabetics prediction/savedmodels/diabetes_model.sav','rb'))
